...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and().csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/publicaciones/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/calificacion/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/calificacion/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/v1/calificacion/**").authenticated()
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/reporte").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/reporte/**").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/reporte/byPublicacion/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/v1/reporte/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/v1/contacto").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/contacto").permitAll()
                .requestMatchers(HttpMethod.DELETE, "/api/v1/contacto/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/mensajeVendedor/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/mensajeVendedor/**").permitAll()
                .anyRequest()
                .authenticated()
                .and()
